...
Outras variáveis que não interessam são as variáveis categóricas com valor único, como por exemplo as variáveis _sex_ e _outcome_.
...
g12 = grid.arrange(g1, g2, ncol=1,nrow=2)
```
